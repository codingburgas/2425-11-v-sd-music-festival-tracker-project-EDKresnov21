...
using MusicFest.DAL.Data;
using MusicFest.DAL.Models;

namespace MusicFest.DAL.Repositories;

public class GroupRepository : TicketManagementDatabaseContext
{
    public static TicketManagementDatabaseContext _context = new TicketManagementDatabaseContext();
